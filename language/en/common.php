...
$lang = array_merge($lang, array(
	...
	'AURELIENAZERTY_SITENOTIFICATION_OLDPRONO_TEXT'	=> '<strong>%1$s</strong>: pronostique ancien',
	'AURELIENAZERTY_SITENOTIFICATION_NOPRONO_TEXT'	=> '<strong>%1$s</strong>: pas de prono',
));
